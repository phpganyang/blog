...
<link rel="stylesheet" type="text/css" href="/Public/Admin/Login/css/style2.0.css">
<style type="text/css">
...
<div id="contPar" class="contPar">
	<div id="page1"  style="z-index:1;">
		...
		<div class="imgGroug">
			<ul>
				<img alt="" class="img0 png" src="/Public/Admin/Login/img/page1_0.png">
				<img alt="" class="img1 png" src="/Public/Admin/Login/img/page1_1.png">
				<img alt="" class="img2 png" src="/Public/Admin/Login/img/page1_2.png">
			</ul>
		</div>
		<img alt="" class="img3 png" src="/Public/Admin/Login/img/page1_3.jpg">
	</div>
</div>
<div class="tyg-div-denglv">
	<div class="tyg-div-form">
		<form action="<?php echo U('index');?>" method="post">
			<h2>登录</h2><p class="tyg-p">欢迎访问  智慧能力 <a href="<?php echo U('Register/register');?>"><span style="color:blue;"><还没注册？></还没注册></span></a></p>
			<div style="margin:5px 0px;">
				<input type="text" name="username" placeholder="请输入账号..."/>
			</div>
			<div style="margin:5px 0px;">
				<input type="password" name="pwd" style="" placeholder="请输入密码..."/>
			</div>
			<div style="margin:5px 0px;">
				<input type="text" name="captch" style="width:150px;" placeholder="请输入验证码..."/>
				<img src="/index.php/Admin/Login/verify"
...
<script type="text/javascript" src="/Public/Admin/Login/js/jquery-1.8.0.min.js"></script>
<script type="text/javascript" src="/Public/Admin/Login/js/com.js"></script>
<!--[if IE 6]>
